...
/**
 * I took this class that was in the apache package and removed, change the code that
 * was not allowed on Google App Engine.
 * 
 * 
 * 
 * 
 ...
 *
 */
public class HttpEngineForGAE implements ClientHttpEngine
{
   private final static Logger logger = Logger.getLogger(HttpEngineForGAE.class);
   ...
   static
   {
      processId = "THIS_IS_TEMP_LOL_FROM_MARK";//ManagementFactory.getRuntimeMXBean().getName().replaceAll("[^0-9a-zA-Z]", "");
   }
   ...
   public HttpEngineForGAE(HttpClient httpClient)
   {
      this.httpClient = httpClient;
   }

   public HttpEngineForGAE(HttpClient httpClient, boolean closeHttpClient)
   {
      this.httpClient = httpClient;
   ...
   public HttpEngineForGAE(HttpClient httpClient, HttpContext httpContext)
   {
      this.httpClient = httpClient;
